...
public interface Pattern<Value, Type> {
	 ...
	 *             as And, Or, Any, etc.
	 */
	<K, T extends TreeCursor<Value, Type>> T build(T tree, Environment< ? extends T> env) throws NotBuildableException;
	 ...
	 */
	<K, T extends TreeCursor<Value, Type>> boolean match(T tree, Environment< T> env);
