...
public class StrategoAdapter {
	 ...
	 */
	public static IStrategoTerm parseFile(String inputFile, String parseTable) throws FileNotFoundException, IOException, InvalidParseTableException, TokenExpectedException, BadTokenException, ParseException, SGLRException {
	 ...
	 * @throws SGLRException on parse error
	 */
	public static IStrategoTerm parseString(String input, String fileName, String parseTable) throws FileNotFoundException, IOException, InvalidParseTableException, TokenExpectedException, BadTokenException, ParseException, SGLRException {
